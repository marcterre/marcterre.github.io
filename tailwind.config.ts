...
const config: Config = {
  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
  			'cyberpunk-radial': 'radial-gradient(circle at center, transparent 0%, rgba(0, 0, 0, 0.8) 100%)',
  			'cyberpunk-linear': 'linear-gradient(to bottom, transparent 50%, rgba(255, 0, 255, 0.05) 50%)'
  		},
  		keyframes: {
  			fadeIn: {
  				'0%': {
